...
<body>
  <div class="container">
    <div class="title">Log in for</div>
    <div class="content">
      <form action="Login1" method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="password" name="pass" placeholder="Enter your Passowrd" required>
          </div>
          <div class="input-box">
        ...
        <div><span class="details" style="color:red">  ${errorMessage}</span></div>
      </form>
    </div>
  </div>
